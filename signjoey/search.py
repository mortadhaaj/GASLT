...
from signjoey.decoders import Decoder, TransformerDecoder, CrossTransformerDecoder
...
def greedy(
    ...
    if isinstance(decoder, (TransformerDecoder, CrossTransformerDecoder)):
...
def beam_search(
    ...
    # init
    transformer = isinstance(decoder, (TransformerDecoder, CrossTransformerDecoder))
    batch_size = src_mask.size(0)
    ...
    if src_mask2 is not None:
        src_mask2 = tile(src_mask2, size, dim=0)  # batch*k x 1 x src_len
